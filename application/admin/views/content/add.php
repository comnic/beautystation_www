<!-- css -->
<link href="/static/admin/css/content_add.css" rel="stylesheet" type="text/css">
<script src="/static/admin/js/content_add.js" charset="UTF-8"></script>
...
<div class="main-wrap col-md-10">
	<div class="main-title" class="col-md-12">컨텐츠 등록</div>
	<div id="contentAdd" class="row">

		<?php echo form_open_multipart('admin.php/contents/add', 'onsubmit="chkSubmit(this.form);"'); ?>
		<input type="hidden" name="relativeProductList" value="">
		<div class="col-md-12">
			<div class="form-group">
				<label for="c_kind">컨텐츠 종류</label>
				<?php echo form_dropdown('c_kind', $data['kind_options'], set_value('c_kind'), 'class="form-control"')	?>
				<?php echo form_error('c_kind'); ?>
			</div>
		
			<div class="form-group">
				<label for="c_channel">채널</label>
				<?php echo form_dropdown('c_channel', $data['channel_options'], set_value('c_channel'), 'class="form-control"')	?>
			...
			<div class="form-group">
				...
				<input type="file" class="form-control" name="userfile" id="userfile" placeholder="이미지를 선택하세요!" value="<?php echo set_value('userfile'); ?>">
...
?>
			...
			<div class="form-group">
				<label for="c_tags">태그</label>
				<input type="text" class="form-control" name="c_tags" id="c_tags" placeholder="태그 목록을 입력하세요!" value="<?php echo set_value('c_tags', $this->input->post('c_tags')); ?>">
