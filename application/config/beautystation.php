...
$config['home_url'] = "http://beautystation.dev";
...
$config['facebook']['redirect_url'] = $config['home_url'] . '/auth/sns_login_facebook';
...
$config['kakao']['redirect_url'] = urlencode($config['home_url'] . '/auth/sns_login_kakao');

$config['naver']['consumer_key'] = 'eCgRaunJ2VhtNqheJVco';
$config['naver']['consumer_key_secret'] = 'wVz2ucPqX5';
$config['naver']['redirect_url'] = urlencode('/auth/sns_login_naver_callback');
