...
foreach($main_banner as $item){
	if($idx == 0){
		...
		$strItems = "<div class=\"item active\"><img src=\"".$item['bnr_src']."\" width=\"100%\" alt=\"".$item['bnr_title']."\"></div>";
	}else{
		$strIndicators .= "<li data-target=\"#mainBannerCarousel\" data-slide-to=\"".$idx++."\"></li>";
		$strItems .= "<div class=\"item\"><img src=\"".$item['bnr_src']."\" width=\"100%\" alt=\"".$item['bnr_title']."\"></div>";
	}
}
?>
		...
		<div id="topRightContents" class="col-md-4">
			<div class="box box2 col-md-12">
				<div class="con-movie">
					<div class="pic">
						<img src="/static/images/content/26.jpg" width="100%">
					</div>
				...
				<div class="col-md-6">
					<ul>
						<li class="box-fill box1 col-md-6">
							<div class="con-fill">
								<img src="/static/images/content/25.jpg">
							</div>
							<div class="wish-box-sm pull-right"><span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span></div>
						</li>
						<li class="box-fill box1 col-md-6">
							<div class="con-fill">
								<img src="/static/images/content/21.jpg" width="100%">
							</div>
							<div class="wish-box-sm pull-right"><span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span></div>
						</li>
						<li class="box-fill box1 col-md-6">
							<div class="con-fill">
								<img src="/static/images/content/22.jpg" width="100%">
							</div>
							<div class="wish-box-sm pull-right"><span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span></div>
						</li>
						<li class="box-fill box1 col-md-6">
							<div class="con-fill">
								<img src="/static/images/content/23.jpg" width="100%">
							</div>
							<div class="wish-box-sm pull-right"><span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span></div>
						</li>
					</ul>
	...
	<div id="section1">
		<div class="box box4 col-md-3">
				<div class="con-movie">
					<div class="pic thumbnail">
						<img src="/static/images/content/20.jpg" width="100%">
					</div>
		...
		<div class="box box4 col-md-5">
			...
			<div class="con-movie">
				<div class="pic thumbnail">
					<img src="/static/images/content/11.jpg" width="100%">
				</div>
		...
		<div class="box4 col-md-2">
			<div class="box box5 col-md-12">
				<div class="con-product-sm">
					<div class="pic thumbnail"><img src="/static/images/product/77757815441f54b24e81402b35386c50.png" width="100%"></div>
					<div class="desc">
						<p class="brand">[마몽드]</p>
						<p class="title">젤리 블러셔</p>
			...
			<div class="box box5 col-md-12">
				<div class="con-product-sm">
					<div class="pic thumbnail"><img src="/static/images/content/09.jpg" width="100%"></div>
					<div class="desc">
	...
	<div id="section2">
		<div class="col-md-3">
			...
			<div class="box-fill box1 col-md-4">
				<div class="con-fill">
					<img src="/static/images/content/26.jpg">
				</div>
				<div class="wish-box-sm pull-right"><span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span></div>
			</div>
		</div>
		<div class="box box6 col-md-2">
			<div class="con-movie-sm">
				<div class="pic thumbnail">
					<img src="/static/images/content/04.jpg" width="100%">
				</div>
		...
		<div class="box box6 col-md-3">
			<div class="con-movie-sm">
				<div class="pic thumbnail">
					<img src="/static/images/content/07.jpg" width="100%">
				</div>
	...
	<div id="section3">
		...
		<div class="box box4 col-md-5">
			<div class="con-movie">
				<div class="pic thumbnail">
					<img src="/static/images/content/19.jpg" width="100%">
				</div>
	...
	<div id="section4">
		<div class="col-md-2">
			<div class="box-fill box7 col-md-6">
				<div class="con-product-xs">
					<div class="pic"><img src="/static/images/product/3b17fc7b04f48343b089799a967434f0.png" width="100%"></div>
					<div class="wish-box-sm pull-right"><span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span></div>
				</div>
			</div>
			<div class="box-fill box7 col-md-6">
			...
			<div class="box-fill box7 col-md-6">
				<div class="con-product-xs">
					<div class="pic"><img src="/static/images/product/1818bd54ca624cbf0e4a465335832da2.png" width="100%"></div>
					<div class="wish-box-sm pull-right"><span class="glyphicon glyphicon-heart-empty" aria-hidden="true"></span></div>
				</div>
			</div>
		...
		<div class="box box2 col-md-3">
			<div class="con-movie">
				<div class="pic thumbnail">
					<img src="/static/images/content/15.jpg" width="100%">
				</div>
		...
		<div class="box box2 col-md-4">
			<div class="con-movie">
				<div class="pic thumbnail">
					<img src="/static/images/content/14.jpg" width="100%">
				</div>
	...
	<div id="section5">
		...
		<div class="col-md-7">
			<div class="box box10 col-md-7">
				<div class="con-movie">
					<div class="pic thumbnail">
						<img src="/static/images/content/13.jpg" width="100%">
					</div>
			...
			<div class="box box10 col-md-5">
				<div class="con-movie">
					<div class="pic thumbnail">
						<img src="/static/images/content/12.jpg" width="100%">
					</div>
